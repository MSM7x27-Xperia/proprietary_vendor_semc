...
PRODUCT_COPY_FILES += \
    ...
    vendor/semc/shakira/proprietary/etc/AudioFilter.csv:system/etc/AudioFilter.csv \
    vendor/semc/shakira/proprietary/etc/AutoVolumeControl.txt:system/etc/AutoVolumeControl.txt \
    vendor/semc/shakira/proprietary/etc/hw_config.sh:system/etc/hw_config.sh \
    vendor/semc/shakira/proprietary/etc/media_profiles.xml:system/etc/media_profiles.xml \
    ...
    vendor/semc/shakira/proprietary/etc/wifi/softap/hostapd.conf:system/etc/wifi/softap/hostapd.conf \
    ...
    vendor/semc/shakira/proprietary/lib/hw/lights.delta.so:system/lib/hw/lights.delta.so \
